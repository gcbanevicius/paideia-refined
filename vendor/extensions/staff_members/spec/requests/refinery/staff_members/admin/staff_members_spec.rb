      ...
      describe "staff_members" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:staff_member, :name => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:staff_member, :name => "A name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:staff_member, :name => "UniqueTitleOne") }
