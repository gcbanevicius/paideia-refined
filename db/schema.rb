...
ActiveRecord::Schema.define(:version => 20130801184714) do
  ...
  create_table "webinar_users", :force => true do |t|
    t.string   "username"
    t.string   "email"
    t.string   "name"
  ...
  create_table "webinar_users_webinars", :id => false, :force => true do |t|
    t.integer "webinar_id"
    t.integer "webinar_user_id"
  end

  add_index "webinar_users_webinars", ["webinar_id", "webinar_user_id"], :name => "index_webinar_users_webinars_on_webinar_id_and_webinar_user_id"
