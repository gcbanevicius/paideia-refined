...
Refinery::Pages.configure do |config|
  ...
  # config.auto_expand_admin_tree = true
   ...
   config.layout_template_whitelist = [:application, :secondarynav]

   config.view_template_whitelist = ["home", "show", "content_page", "content_page_split", "left_banner", "webinar"] #photo_gallery_home, photo_gallery_child
