...
Refinery::Images.configure do |config|
  ...
  config.s3_bucket_name = 'paideiainstitute'
  config.s3_access_key_id = 'AKIAIQAPQZDNN3TDRBQQ'
  config.s3_secret_access_key = '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'
